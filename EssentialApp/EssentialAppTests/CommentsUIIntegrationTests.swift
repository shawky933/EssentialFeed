...
//  EssentialAppTests
//
//  Created by Shawky Elhanak on 13.02.25.
//
    ...
    private func assertThat(
        ...
        viewModel.comments.enumerated().forEach { index, comment in
            XCTAssertEqual(
                ...
                comment.message,
                "Expected comment message to be \(comment.message) at index \(index)",
                file: file,
                line: line
            )
            XCTAssertEqual(
                ...
                comment.date,
                "Expected comment date to be \(comment.date) at index \(index)",
                file: file,
                line: line
            )
            XCTAssertEqual(
                ...
                comment.username,
                "Expected comment username to be \(comment.username) at index \(index)",
                file: file,
                line: line
            )
        }
